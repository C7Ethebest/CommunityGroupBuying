...
__DEFINE__(1654652886938, function(require, module, exports) {
var fs = require('fs'),
    tls = require('tls'),
    zlib = require('zlib'),
...
}, function(modId) {var map = {"./parser":1654652886939}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1654652886939, function(require, module, exports) {
...
return __REQUIRE__(1654652886938);
})()
